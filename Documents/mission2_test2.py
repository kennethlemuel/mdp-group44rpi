...
try:
    ...
    queue_state_transition("FP_1", 3000, 100, 50)
    wait_to_send()
    first_obs = 0
    if (first_obs == 1): #left
        ...
        queue_state_transition("FP_1", 3000, 150, 35)
    else: #right
    ...
    if (second_obs == 1):
        ...
        queue_state_transition("FORWARD_RIGHT", 1000, 70, 0)
        queue_state_transition("FORWARD_UPO", 3000, 100, 1)
        #queue_state_transition("BACKWARD", 2000, 10, 0)
        queue_state_transition("FORWARD_LEFT", 1000, 60, 0)
        queue_state_transition("FORWARD_LEFT", 1000, 60, 0)
        queue_state_transition("FORWARD_UPO", 3000, 100, 1)
        queue_state_transition("FORWARD_LEFT", 1000, 60, 0)
        queue_state_transition("FP_2", 4000, 0, 80)
        queue_state_transition("FORWARD_LEFT", 1000, 60, 0)
        queue_state_transition("BACKWARD", 2000, 40, 0)
        queue_state_transition("FORWARD_RIGHT", 1000, 70, 0)
        queue_state_transition("FP_1", 1000, 100, 15)
